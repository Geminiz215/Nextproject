        ...
        <Box width={["300px","40%", "30%"]} p="2">
          ...
          <Box display={"flex"} flexDir="column" gap={"3"} p="1">
            <Flex>
              ...
              <Text ml={"3"} as="cite" width={["300px","100%","100%" ]}>Ruko D'Smart Blok I 06 Perumahan Duta Harapan/Telaga Mas, Kelurahan, Harapan Baru, Kec. Bekasi Utara, Kota Bks, Jawa Barat 17123</Text>
            </Flex>
            <Flex>
              <Image src="/images/icon/email.png" boxSize={"5"} />
              <Text ml={"3"} as="cite">thif@gmail.com</Text>
            </Flex>
            <Flex>
              <Image src="/images/icon/phone.png" boxSize={"5"} />
              <Text ml={"3"} as="cite">+123456789</Text>
            </Flex>
          </Box>
        </Box>
        <Box width={["300px","40%", "30%"]} p="2">
