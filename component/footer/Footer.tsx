      ...
      >
        ...
        <Box width={["100%", "100%", "40%", "30%"]} p="2">
          ...
          <Text color={"white"} fontSize="xs" as={"cite"} width="300px">
            Rumah Makan Waroeng solo adalah perusahaan yang menekuni bidang
            kuliner yaitu rumah makan. Rumah Makan Waroeng solo pertama kali
            berdiri pada awal tahun 2021, fokus Rumah Makan Waroeng solo yaitu
            menjadikan rumah makan dengan menu kuliner cita rasa tradisional
            khas daerah Jawa.
          </Text>
        </Box>
